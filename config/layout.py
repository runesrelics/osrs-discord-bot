...
FONT_SIZES = {
    'username': 72,     # Increased from 48
    'price': 64,       # Increased from 42
    'description': 52  # Increased from 36
}
...
TEXT_CONFIG = {
    ...
    'description': {
        ...
        'line_spacing': 15,      # Increased from 10
    },
    'account_type': {
        'position': (550, 1150),  # Position of account type label
        'font_size': 52,          # Increased from 36
